        ...
        <form className="flex flex-col items-center mb-4">
            ...
            <div className="flex gap-5 flex-col my-4 w-96">
                <div className="flex flex-col gap-1 items-start w-full">
                    <label htmlFor="email" className="font-bold px-1 text-lg">이메일</label>
                    <input type="text" id="email" className="border border-gray-200 rounded-lg px-4 py-1.5 w-full"
                           disabled={true}
                           value={user.nickname}/>
                </div>
                <div className="flex flex-col gap-1 items-start w-full">
                    <label htmlFor="nickname" className="font-bold px-1 text-lg">닉네임</label>
                    <input type="text" id="nickname" className="border border-gray-200 rounded-lg px-4 py-1.5 w-full"
                ...
                <div className="flex flex-col gap-1 items-start w-full">
                    <label htmlFor="password" className="font-bold px-1 text-lg">비밀번호</label>
                    <input id="password" type="password"
                           className="border border-gray-200 rounded-lg px-4 py-1.5 w-full resize-none"/>
                </div>
                <div className="flex flex-col gap-1 items-start w-full">
                    <label htmlFor="passwordConfirm" className="font-bold px-1 text-lg">비밀번호 확인</label>
